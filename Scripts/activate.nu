...
let virtual-env = "C:\Users\opust\OneDrive\Desktop\All python files\FTC(For copy)"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "C:\Users\opust\OneDrive\Desktop\All python files\FTC(For copy)\Scripts\deactivate.nu"
